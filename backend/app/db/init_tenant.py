...
def init_roles(db: Session) -> None:
    ...
    roles = [
        ...
        {"id": "MEMBER", "is_reserved": True, "is_standard": True},
...
def init_access_control(db: Session) -> None:
    ...
    access_control_entries = [
        ...
        {"resource_type_id": "account", "role_id": "PROF", "permission": "read"},
        {"resource_type_id": "account", "role_id": "STANDARD", "permission": "read"},
        ...
        {"resource_type_id": "opportunity", "role_id": "MEMBER", "permission": "read"},
